            ...
            <section class="container my-5">
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card h-100 text-center shadow-sm admin-card">
                            <div class="card-body p-4 d-flex flex-column">
                                <i class="fas fa-seedling fs-1 mb-3 admin_icon"></i>
                                <h5 class="card-title">Manage Flower Data</h5>
                                <p class="card-text">Review and modify the main flower data table.</p>
                                <a href="manage_flowers.php" class="btn btn-dark mt-auto">Go to Management</a>
                            </div>
                        </div>
                    </div>
